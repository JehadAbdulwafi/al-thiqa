      ...
      <div className="pt-4">
        ...
        <div className="flex items-center gap-3">
          <div className="text-2xl font-bold text-gray-900">
            {formatPrice(product.price)} <span className="text-sm font-normal text-gray-600">د.ل</span>
          </div>
          {hasDiscount && <div className="text-sm text-gray-400 line-through">{formatPrice(product.compareAtPrice)} د.ل</div>}
        </div>
      </div>
    </div>
  )
